...
public abstract class AdvancedIntentService extends Service {
    ...
    private final class ServiceHandler extends Handler {
        ...
        private int handledMessagesCount = 0;
     ...
     */
    public AdvancedIntentService(String name) {
        super();
        mName = name;
    }
    ...
    protected int getQueueSize() {
        return mServiceHandler.getTotalMessagesCount();
    }

    protected int getQueueProgress() {
        return mServiceHandler.getHandledMessagesCount();
    }
}
